...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    gate_enter: 'Enter',
    done_title: 'Done',
    done_subtitle: 'What you’ve already left behind. No rush.',
  ...
  ca: {
    ...
    gate_enter: 'Entra',
    done_title: 'Fetes',
    done_subtitle: 'El que ja has deixat enrere. Sense pressa.',
  ...
  es: {
    ...
    gate_enter: 'Entra',
    done_title: 'Hechas',
    done_subtitle: 'Lo que ya has dejado atrás. Sin prisa.',
