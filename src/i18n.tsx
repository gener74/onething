...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    input_placeholder: 'Write the thing you’re stuck on…',
    add_aria: 'Add a thing',
    add: 'Add',
    empty_title: 'One thing at a time.',
    empty_motto: 'When you don’t know where to start, I’ll break it into steps.',
    empty_hint: 'Write it up there ↑ — whatever you’re stuck on.',
  ...
  ca: {
    ...
    today_short: 'avui',
    lets_start: 'comencem',
    input_placeholder: 'Escriu la cosa que se t’encalla…',
    add_aria: 'Afegir una cosa',
    add: 'Afegir',
    empty_title: 'Una cosa a la vegada.',
    empty_motto: 'Quan no sàpigues per on començar, t’ho parteixo en passos.',
    empty_hint: 'Escriu-ho aquí dalt ↑ — allò que se t’encalla.',
  ...
  es: {
    ...
    input_placeholder: 'Escribe la cosa que se te atasca…',
    add_aria: 'Añadir una cosa',
    add: 'Añadir',
    empty_title: 'Una cosa a la vez.',
    empty_motto: 'Cuando no sepas por dónde empezar, te lo parto en pasos.',
    empty_hint: 'Escríbelo aquí arriba ↑ — lo que se te atasca.',
