...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    empty_hint: 'Write what you’re stuck on up there. When you don’t know where to start, I’ll break it into steps.',
  ...
  ca: {
    ...
    empty_hint: 'Escriu aquí dalt el que tens encallat. Quan no sàpigues per on començar, t’ho parteixo en passos.',
  ...
  es: {
    ...
    empty_hint: 'Escribe aquí arriba lo que tienes atascado. Cuando no sepas por dónde empezar, te lo parto en pasos.',
