...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    empty_motto: 'We’ll turn it into small steps, so you only have to worry about the next one.',
  ...
  ca: {
    ...
    empty_motto: 'La convertirem en petits passos perquè només t’hagis de preocupar del següent.',
  ...
  es: {
    ...
    empty_motto: 'La convertiremos en pequeños pasos para que solo tengas que preocuparte del siguiente.',
