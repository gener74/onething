...
const DICT: Record<Lang, Dict> = {
  en: {
    ...
    input_placeholder: 'What task are you struggling to start?…',
    add_aria: 'Add a thing',
    add: 'Add',
    empty_title: 'One thing at a time.',
    empty_motto: 'I’ll turn it into small steps, so you only have to worry about the next one.',
    empty_hint: 'Write up here the task you’re struggling to start.',
    first_q: 'What’s that task you’re struggling to start?',
    first_sub: 'Tell me, and I’ll break it into small steps. We’ll keep just the first one.',
    first_ph: 'Write it here…',
    first_cta: 'Start',
    ...
    capture_next: 'Note the next thing',
    capture_next_ph: 'What’s the next thing?',
    capture_next_save: 'Note it',
    captured_msg: 'Noted. It’s waiting for you in {bucket}.',
  ...
  ca: {
    ...
    today_short: 'avui',
    lets_start: 'comencem',
    input_placeholder: 'Quina tasca t’està costant començar?…',
    add_aria: 'Afegir una cosa',
    add: 'Afegir',
    empty_title: 'Una cosa a la vegada.',
    empty_motto: 'La convertiré en petits passos perquè només t’hagis de preocupar del següent.',
    empty_hint: 'Escriu aquí dalt la tasca que t’està costant començar.',
    first_q: 'Quina és aquella tasca que et costa començar?',
    first_sub: 'Digue-me-la i te la parteixo en passos petits. Ens quedem només amb el primer.',
    first_ph: 'Escriu-la aquí…',
    first_cta: 'Comença',
    ...
    capture_next: 'Anota la següent cosa',
    capture_next_ph: 'Quina és la següent cosa?',
    capture_next_save: 'Anota-la',
    captured_msg: 'Anotat. T’espera a {bucket}.',
  ...
  es: {
    ...
    input_placeholder: '¿Qué tarea te cuesta empezar?…',
    add_aria: 'Añadir una cosa',
    add: 'Añadir',
    empty_title: 'Una cosa a la vez.',
    empty_motto: 'La convertiré en pequeños pasos para que solo tengas que preocuparte del siguiente.',
    empty_hint: 'Escribe aquí arriba la tarea que te cuesta empezar.',
    first_q: '¿Cuál es esa tarea que te cuesta empezar?',
    first_sub: 'Dímela y la parto en pasos pequeños. Nos quedamos solo con el primero.',
    first_ph: 'Escríbela aquí…',
    first_cta: 'Empieza',
    ...
    capture_next: 'Apunta la siguiente cosa',
    capture_next_ph: '¿Cuál es la siguiente cosa?',
    capture_next_save: 'Apúntala',
    captured_msg: 'Apuntado. Te espera en {bucket}.',
