...
const CONTENT: Record<Lang, { title: string; body: string[] }> = {
  en: {
    ...
    body: [
      ...
      'The only thing we count is four anonymous totals along the way: how many people enter the app, how many capture a first task, how many breakdowns are shown, and how many reach a first step. It tells us whether OneThing actually helps people get started. No content and no identifier ever leave with it — just a +1.',
  ...
  ca: {
    ...
    body: [
      ...
      'L’única cosa que comptem són quatre totals anònims del recorregut: quanta gent entra a l’app, quanta captura una primera tasca, quants desglossaments es mostren i quants arriben al primer pas. Ens diu si OneThing ajuda de debò a començar. Mai no hi viatja cap contingut ni cap identificador —només un +1.',
  ...
  es: {
    ...
    body: [
      ...
      'Lo único que contamos son cuatro totales anónimos del recorrido: cuánta gente entra en la app, cuánta captura una primera tarea, cuántos desgloses se muestran y cuántos llegan al primer paso. Nos dice si OneThing ayuda de verdad a empezar. Nunca viaja ningún contenido ni identificador —solo un +1.',
