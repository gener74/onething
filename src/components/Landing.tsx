...
> = {
  en: {
    ...
    diff: 'ChatGPT gives you a plan. OneThing accompanies you until you begin.',
    cta: 'Try it',
  ...
  ca: {
    ...
    diff: 'ChatGPT et dóna un pla. OneThing t’acompanya fins que comences.',
    cta: 'Prova-ho',
  ...
  es: {
    ...
    diff: 'ChatGPT te da un plan. OneThing te acompaña hasta que empiezas.',
    cta: 'Pruébalo',
